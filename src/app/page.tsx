      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 leading-normal md:leading-normal">
                Transformamos Ideas en<br />Realidad Digital
              </h1>
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 leading-normal md:leading-normal">
                ¿Por qué elegirnos?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  className="bg-gray-800/50 rounded-xl p-8 hover:transform hover:scale-105 transition-all duration-300"
                >
                  <div className="bg-gray-700/50 rounded-lg p-4 inline-block mb-6">
                    {feature.icon}
                  </div>
